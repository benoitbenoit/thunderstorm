...
public class CorrelationDriftEstimator {
    ...
    public static CrossCorrelationDriftResults estimateDriftFromCoords(
        ...
        for(int i = 1; i < steps; i++) {
            ...
            multiplyImageByGaussianMask(new Point2D.Double(-driftXofImagePrevious/magnification + lowResPaddedSize / 2, -driftYofImagePrevious/magnification + lowResPaddedSize / 2), lowResPaddedSize, lowResCrossCorrelationImage);
